...
namespace NoteApp.UnitTests
{
    public class NoteTest
    {
        ...
        {
            _note = new Note("Заголовок", Category.Work, "Текст", DateTime.Today) { TimeLastChange = DateTime.Today };
        }

        [TestCase("Заголовок", "Геттер Name возвращает неправильный заголовок",
            TestName = "Позитивный тест геттера Name")]
        [TestCase("Заголовок", "Сеттер Name записывает неправильный заголовок",
        ...
        {
            var expectedNote = new Note("Заголовок", Category.Work, "Текст", DateTime.Today) { TimeLastChange = DateTime.Today };
            var actual = _note;
